"""
Django settings for swainerstag project.
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'swainerstag/static'),
]

WSGI_APPLICATION = 'swainerstag.wsgi.application'
